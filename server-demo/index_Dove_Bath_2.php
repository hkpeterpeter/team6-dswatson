...
2702795 - BODY WASH - BEAUTY NOURISHING
                  ...
                  <li class="dropdown">
                    <a href="#" class="nav-link" data-toggle="dropdown" > <span>    <i class="fa fa-mobile" aria-hidden="true"></i> </span> Whisper</a>
                    <ul class="dropdown-menu" role="menu">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <tr>
              ...
              <td>
                <h4 style="border: 1px solid; padding:20px;">
                  ...
                  Increase in Supplier Revenue:
                  <span id="labelSupplyRevenue">&nbsp;</span>
                </h4>
          ...
          */
            ...
            if ( grossMargin < maxGrossMargin ) {
                ...
                focus.select('path#controlExtendedLineY').remove();
                      focus.append("path")
                          ...
                          // update the supplier revenue
                           $("#labelSupplyRevenue").text(parseFloat( supplyRevenue(point[1]*grossMargin, point[0])).toFixed(2) + "");
          ...
          function dragged(d) {
              ...
              // update the supplier revenue
               $("#labelSupplyRevenue").text(parseFloat( supplyRevenue(d[1]*grossMargin, d[0])).toFixed(2) + "");
